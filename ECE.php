			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Computer Engineering Classes</h1>
								<p>Here are the links for each Computer Engineering class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['ECE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['ECE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['ECE']].">".$row1[$row['ECE']]."</a></td>
						        </tr>";

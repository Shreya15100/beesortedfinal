			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Civil and Environmental Engineering Classes</h1>
								<p>Here are the links for each Civil and Environmental Engineering class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['CEE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['CEE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['CEE']].">".$row1[$row['CEE']]."</a></td>
						        </tr>";

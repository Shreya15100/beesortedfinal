			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Materials Science and Engineering Classes</h1>
								<p>Here are the links for each Materials Science and Engineering class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['MSE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['MSE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['MSE']].">".$row1[$row['MSE']]."</a></td>
						        </tr>";

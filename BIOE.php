			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Bioengineering Classes</h1>
								<p>Here are the links for each Bioengineering Engineering class</p>
								<h1>
                                <?php
							    ...
							    $sql= "SELECT * from BIOE";
							    $result= $conn-> query($sql);
							    $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
							    echo"<table>
							    <tr>
							    <th>".$row['BIOE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['BIOE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['BIOE']].">".$row1[$row['BIOE']]."</a></td>
						        </tr>";

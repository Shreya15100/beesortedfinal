			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Chemical and Biomolecular Engineering Classes</h1>
								<p>Here are the links for each Chemical and Biomolecular Engineering class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['CHBE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['CHBE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['CHBE']].">".$row1[$row['CHBE']]."</a></td>
						        </tr>";

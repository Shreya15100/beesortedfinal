			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Engineering Physics Classes</h1>
								<p>Here are the links for each Engineering Physics class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['PHYS']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['PHYS'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['PHYS']].">".$row1[$row['PHYS']]."</a></td>
						        </tr>";

			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Industrial Engineering Classes</h1>
								<p>Here are the links for each Industrial Engineering class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['IE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['IE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['IE']].">".$row1[$row['IE']]."</a></td>
						        </tr>";

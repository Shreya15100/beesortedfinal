			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Nuclear, Plasma, and Radiological Engineering Classes</h1>
								<p>Here are the links for each Nuclear, Plasma, and Radiological Engineering class</p>
								<h1>
                                <?php
							    ...
							    $sql= "SELECT * from NPRE";
							    $result= $conn-> query($sql);
							    $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
							    echo"<table>
							    <tr>
							    <th>".$row['NPRE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['NPRE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['NPRE']].">".$row1[$row['NPRE']]."</a></td>
						        </tr>";

			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Systems Engineering and Design Classes</h1>
								<p>Here are the links for each Systems Engineering and Design class</p>
								<h1>
                                <?php
							    ...
							    <tr>
							    <th>".$row['SE']."</th></tr>";
	                            $sql1= "SELECT * from ".$row['SE'];
							    $result1= $conn-> query($sql1);
							    $row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC);	
						ECHO  "<tr>
						        <td><a href=".$row1[$row['SE']].">".$row1[$row['SE']]."</a></td>
						        </tr>";
